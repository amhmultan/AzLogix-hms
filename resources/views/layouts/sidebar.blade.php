<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex items-center justify-center mt-6">
                <div class="flex items-center">
                    <h1 class="font-bold text-center tracking-wider text-4xl text-yellow-500">Amh<span class="text-blue-500">Soft</span></h1>
                </div>
            </div>
    
            <nav class="mt-10">
                <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.dashboard') ? 'active' : '' }} " href="{{ route('admin.dashboard')}}">
                ...
                <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.roles.index') ? 'active' : '' }}" href="{{ route('admin.roles.index') }}">
                ...
                @canany('Permission access','Permission add','Permission edit','Permission delete')
                 <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.permissions.index') ? 'active' : '' }}"
                ...
                <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.users.index') ? 'active' : '' }}"
                ...
                @canany('Post access','Post add','Post edit','Post delete')
                 <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.posts.index') ? 'active' : '' }}"
                ...
                @canany('Patient access','Patient add','Patient edit','Patient delete')
                 <a class="text-decoration-none flex items-center mt-2 py-2 px-6 text-gray-500 hover:bg-blue-700 hover:text-yellow-400 {{ Route::currentRouteNamed('admin.patients.index') ? 'active' : '' }}"
