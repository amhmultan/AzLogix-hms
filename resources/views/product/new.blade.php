   ...
   <div>
        <main>
            <div class="container bg-white shadow-md rounded my-6 px-5 py-4">
                ...
                <h3 class="h2 mb-4 fw-bold text-success">Add Products</h3>
                <hr />
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <input id="packing" type="text" name="packing" value="{{ old('packing') }}" class="form-control" />
                    </div>
                    <div class="col-md-2">
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                      ...
                      <input id="quantity" type="number" name="quantity" value="{{ old('quantity') }}" class="form-control" />
                    </div>
                    <div class="col-md-4">
                      <label for="batch_number" class="text-gray-700 font-black">Batch No.</label>
                      <input id="batch_number" type="text" name="batch_number" value="{{ old('batch_number') }}" class="form-control" />
                    </div>
                    <div class="col-md-2">
                      <label for="expiry_date" class="text-gray-700 font-black">Expiry Date:</label>
                      <input id="expiry_date" type="date" name="expiry_date" value="{{ old('expiry_date') }}" class="form-control" />
                    </div>
